...
class ActorCritic_Teacher(nn.Module):
    ...
    def __init__(self,  
        ...
        #                         latent_dim=16)
        #MlpVqvaeFallAnglePredictRegressionActor
        self.actor_teacher_backbone = MlpVqvaeLongEstLayerNormFallPredictRegressionTeacherVQActor(num_prop=num_prop,#remove linear vel
                                num_hist=num_hist,
                                num_actions=num_actions,
                                actor_dims=[512,256,128],
                                activation=activation,
