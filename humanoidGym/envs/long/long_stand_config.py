...
class LongStandRoughCfg( LeggedRobotCfg ):
    ...
    class control( LeggedRobotCfg.control ):
        ...
        action_scale = 0.25#0.5#1#0.5#1#0.5
...
class LongStandRoughCfgPPO( LeggedRobotCfgPPO ):
    class policy:
        init_noise_std = 0.8
