...
class LongOriSopUnevenRoughCfg( LeggedRobotCfg ):
    ...
    class control( LeggedRobotCfg.control ):
        ...
        action_scale = 0.25#0.25#1#0.5#1#0.5
    ...
    class asset( LeggedRobotCfg.asset ):
        ...
        knee_name = ['left_knee_pitch_Link', 'right_knee_pitch_Link']
        penalize_contacts_on = ['left_knee_pitch_Link', 'right_knee_pitch_Link']
    ...
    class rewards( LeggedRobotCfg.rewards ):
        ...
        base_height_target = 1.25
        only_positive_rewards = True
        
        target_joint_pos_scale = 0.26
        # local frame   
        target_feet_height = -1.0#-1.0    
        cycle_time = 0.8
...
class LongOriSopUnevenRoughCfgPPO( LeggedRobotCfgPPO ):
    class policy:
        init_noise_std = 0.8
