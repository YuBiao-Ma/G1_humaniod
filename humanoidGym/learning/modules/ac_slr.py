...
from humanoidGym.learning.utils import resolve_nn_activation

from humanoidGym.learning.utils.helper import mlp_factory

from .ac_base import AcNet, ActorCriticMlp
...
class ActorCriticMlpSlr(ActorCriticMlp):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.num_obs_h1 = num_actor_obs-3-2-1
        ...
        self.trans = nn.Sequential(*mlp_factory(
            activation=resolve_nn_activation(activation),
